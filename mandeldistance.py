...
class MandelDistance(MandelbrotSolo):
    def __init__(self, dive_mesh, frame_number, output_folder_name, extra_params={}):
        ...
        self.smooth_counts_array = None
        self.escape_radius = 100000 # Because, who knows.
    ...
    def generate_counts(self):
        ...
        (self.counts_array, self.smooth_counts_array, self.last_values_real_array, self.last_values_imag_array) = self.dive_mesh.mathSupport.mandelbrotDistanceEstimate(self.mesh_real_array, self.mesh_imag_array, self.escape_radius, self.max_escape_iterations)
    ...
    def process_counts(self):
        self.processed_array = self.smooth_counts_array
